  ...
  return (
    <div className="z-30 flex flex-col">
      ...
      <div className="flex  max-w-[700px] md:w-[700px]  flex-col items-center justify-center md:p-[20px]">
        <div className="border rounded-lg p-8  flex md:max-w-[700px] w-full bg-gray-custom-100  p-[20px] border border-gray-custom-200">
          <AggregationChoices />
        </div>

        <div className="border rounded-lg p-8  mt-[24px] flex w-full max-w-[700px]  bg-gray-custom-100 p-[20px] border border-gray-custom-200">
          <AggregationResults />
        </div>
      </div>
    </div>
